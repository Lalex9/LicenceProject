...
export class CheckoutComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, private formService: PlanMyShoppingFormService, private cartService: CartService, private checkoutService: CheckoutService, private router: Router) { }
  ...
  ngOnInit(): void {
    ...
    this.checkoutFormGroup = this.formBuilder.group({
      customer: this.formBuilder.group({
        firstName: new FormControl('', [Validators.required, Validators.minLength(2), PlanMyShoppingValidators.notOnlyWhitespace]),
        lastName: new FormControl('', [Validators.required, Validators.minLength(2), PlanMyShoppingValidators.notOnlyWhitespace]),
  ...
  reviewCartDetails() {
    this.cartService.totalQuantity.subscribe(
      qunatity => this.totalQuanity = qunatity
    );
